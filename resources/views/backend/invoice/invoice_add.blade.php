                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="md-3">
                                        ...
                                        <i
                                            class="btn btn-info btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore">
                                            Add More</i>
                                    </div>
                                </div>
                            </div> <!-- // end row  -->
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('invoice.store') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="tax_amount" id="tax_amount"
                                                    class="form-control estimated_amount" placeholder="Tax %" maxlength="2">

                                                    {{-- <select name="tax_amount" id="tax_amount" class="form-select"
                                                    aria-label="Default select example">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-9">
                                        ...
                                        <select name="customer_id" id="customer_id" class="form-select select2" required>
                                            ...
                                            <option value="0" class="bg-success">New Customer </option>
                                ...
                                <div class="form-group">
                                    <button type="submit" disabled class="btn btn-info" id="storeButton"> Invoice
                                        Store</button>
                                </div>
                            </form>
                        </div> <!-- End card-body -->
...
<tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <td>
     ...
     <td>
        <input type="number" min="1" class="text-right form-control selling_qty" name="selling_qty[]" value="" required>
    </td>
    <td>
        <input type="number" class="text-right form-control unit_price" name="unit_price[]" value="" required>
    </td>
     ...
     <td>
        <i class="btn btn-danger fas fa-trash-alt removeeventmore"></i>
    </td>
    </tr>
        ...
        $(document).ready(function() {
            ...
            function totalAmountPrice() {
                ...
                if (!isNaN(tax_amount) && tax_amount.length != 0) {
                    ...
                    sum2 = sum * tax_amount / 100;
                    console.log(tax_amount, sum);
                }
                $('#estimated_amount').val(sum + sum2);
            }
