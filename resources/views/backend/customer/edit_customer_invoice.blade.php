                    ...
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('credit.customer') }}"
                                ...
                                <i class="ri-arrow-drop-left-fill"> Back </i>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($invoice_details as $key => $details)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">{{ number_format($details->selling_price) }}
                                                                    </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="no-line text-center">
                                                                    ₹{{ number_format($payment->discount_amount) }}</td>
                                                            </tr>
                                                            @endif
                                                            <tr>
                                                                {{-- <td class="no-line"></td> --}}
                                                                ...
                                                                <td class="no-line text-center">₹{{ number_format($payment->paid_amount) }}
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="no-line text-center">₹{{ number_format($payment->due_amount) }}
                                                                </td>
                                                            </tr>
                                                            @endif
                                                            <tr>
