                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('customer.update') }}" id="myForm"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="mobile_no" value="{{ $customer->mobile_no }}" id="input-repeat"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg"
                                            src="{{ $customer->customer_image ? asset($customer->customer_image) : url('upload/no_image.jpg') }}" alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->
