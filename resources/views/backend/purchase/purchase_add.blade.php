                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        ...
                                        <input class="form-control example-date-input" name="purchase_no" value="{{ $unique_purchase_no }}" type="text" id="purchase_no" readonly>
                                    </div>
                                </div>
...
<tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <td width="30%">
     ...
     <td>
        <input type="number" min="1" class="text-right form-control buying_qty" name="buying_qty[]" value="" required>
    </td>
 ...
 <td>
     ...
     <td>
        <i class="fas fa-trash-alt removeeventmore btn btn-danger text-center"></i>
    </td>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(document).on("click", ".addeventmore", function() {
                ...
                console.log(supplier_id, category_id, category_name, product_id, product_name);
            ...
            $(document).on('change', '#supplier_id', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var html = '<option selected disabled value="">Select Category</option>';
