...
class PurchaseController extends Controller
{
    ...
    public function PurchaseAdd()
    {
        ...
        $purchase = Purchase::orderBy('id', 'desc')->first()->id;
        $unique_purchase_no = "P" . random_int(100, 999) . ($purchase + 1);
        $date = date('Y-m-d');

        return view('backend.purchase.purchase_add', compact('supplier', 'unit', 'category', 'unique_purchase_no', 'date'));
    } // End Method
    ...
    {
        $allData = Purchase::orderBy('date', 'desc')->orderBy('id', 'desc')->orderBy('status', 'asc')->where('status', '0')->get();
